...
output += pipeline('./Simulation_1/via_region_data.csv', './Simulation_1')
output += pipeline('./Simulation_2/via_region_data.csv', './Simulation_2')
#output += pipeline('./RosBag/bag_region_data.csv', './RosBag')
print(output)
      
# Write it to a csv file
with open('sim_compiled_traffic_lights.csv', 'w') as the_file:
